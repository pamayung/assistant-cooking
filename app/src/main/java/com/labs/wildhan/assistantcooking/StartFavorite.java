...
public class StartFavorite extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player, boolean wasRestored) {
        model = (FavoriteModel)getIntent().getSerializableExtra(KEY_ITEM);
        if(!wasRestored){
